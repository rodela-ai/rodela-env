...
#  nvminikube create cluster -n $2 --config data/minikube/minikube-gpu.yaml
...
install_ingress () {
  ...
  # kubectl apply -f https://minikube.sigs.k8s.io/examples/ingress/deploy-ingress-nginx.yaml
  sleep 5
...
then
  ...
  nvminikube delete clusters $2
  exit
fi
if [ "$1" == "minikube" ]
then
  #local_set_gpu_use $1 $2 
  deploy_minikube_cluster $1 $2
  #post_minikube_cluster_gpu $1 $2
  test_gpu_use $1 $2 
fi
